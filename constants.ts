...
export const DESIGNS: Design[] = [
  // Circle Designs
  { id: 'c1', code: 'C-01', price: 400, shape: Shape.CIRCLE, image: './decor_circle_1.jpg', title: 'Blue Mandala Bloom', category: 'decor' },
  { id: 'c2', code: 'C-02', price: 600, shape: Shape.CIRCLE, image: './decor_circle_2.jpg', title: 'Jagannath Traditional', category: 'decor' },
  { id: 'c3', code: 'C-03', price: 1000, shape: Shape.CIRCLE, image: './decor_circle_3.jpg', title: 'Durga Maa Essence', category: 'decor' },
  { id: 'c4', code: 'C-04', price: 1000, shape: Shape.CIRCLE, image: './decor_circle_4.jpg', title: 'Maa Samleswari blessing', category: 'decor' },
  ...
  // Name Plate Designs
  { id: 'np1', code: 'NP-01', price: 800, shape: Shape.RECTANGLE, image: './name_plate_1.jpg', title: 'Swagat Shreehit', category: 'name-plate' },
